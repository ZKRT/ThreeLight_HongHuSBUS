...
uint8_t pwm_zoomout = 0;		//PWM通道4，焦距变小
...
void action_hangxiang(void)
{
	...
	{
		tx_channel_in[Yaw_cnyh] = 3000 - pwm_hangxiang;
	}
...
//云台模式切换 1510跟随，1900锁头，1100回中，上电是跟随模式，循环切换
void action_modesw(void)
{
	if (tx_channel_in[ModeSw_cnyh] == 1100)
	{
		tx_channel_in[ModeSw_cnyh] = 1510;
	}
	else if (tx_channel_in[ModeSw_cnyh] == 1510)
	{
